...
function get_seat_utilization_chart(type){
    var timestap = get_timestap(type);
    
    var url = "statistics/seat_utilization/";
    var arr = [];
    data = {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.plot($("#seat_utilization"), dataset, options);
        }  
    });  
    ...
    function chart_data(data){
        ...
        for( var key  in data.reservations ){     
            ...
            res.push([time , (data.reservations[key].guest_number)]);
        }
        return res;
    }
