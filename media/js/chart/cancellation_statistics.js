...
function get_cancellation_statistics_chart(type){
    var timestap = get_timestap(type);
    
    var url = "statistics/cancellation_statistics/";
    var arr = [];
    data = {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.plot($("#cancellation_statistics"), dataset, options);
        }  
    });  
    ...
    function chart_data(data){
        ...
        for( var key  in data.reservations ){     
            ...
            res.push([time , (data.reservations[key].cancelled)]);
        }
        return res;
    }
