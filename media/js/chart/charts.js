...
$(document).ready(function(){
    ...
    get_over_reserved_statistics_chart("day");
});
...
$("#weekly").on("click", function(){
    ...
    get_over_reserved_statistics_chart("week");
});
$("#monthly").on("click", function(){
    ...
    get_over_reserved_statistics_chart("month");
});
$("#yearly").on("click", function(){
    ...
    get_over_reserved_statistics_chart("year");
});