...
function get_no_show_statistics_chart(type){
    var timestap = get_timestap(type);
    
    var url = "statistics/no_show_statistics/";
    var arr = [];
    data = {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.plot($("#no_show_statistics"), dataset, options);
        }  
    });  
    ...
    function chart_data(data){
        ...
        for( var key  in data.reservations ){     
            ...
            res.push([time , (data.reservations[key].no_shows)]);
        }
        return res;
    }
