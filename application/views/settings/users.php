...
<ul class="nav nav-tabs settings_tabs">
	<li><a href="<?php echo(URL.'setup'); ?>">Outlet</a></li>
	<li class="active"><a href="<?php echo(URL.'setup/users'); ?>">Users</a></li>
</ul>
<div id="users_settings" class="settings">
	<div class="settings_header">
			...
			<h3 class="m-b-xs text-black">Existing outlets</h3>
		</div>
			...
			<table>
				...
				<?php 
					foreach($users as $usr){
						...
						echo "<td><a href='".URL."setup/users/".$usr["user_id"]."'>".$usr["user_name"]."</a></td>";
